...
<html>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    ...
    <div style="padding:25px;">
        ...
        <a style="margin-top: 10px;" class="btn btn-primary" href="CreateAccount.jsp">Create Account</a>
    </div>
    <%
		Boolean invalidLogin = (Boolean)session.getAttribute("invalidLogin");
		if(invalidLogin != null){
			if(invalidLogin){
				%><script>function showAlert(){alert("<%out.write("Login Failed: Username or Password was invalid.");%>");}</script><%
			}else{
